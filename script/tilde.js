const CONFIG = {
    ...
    commands: [{
        ...
        },
        {
            ...
            pathUrl: 'https://www.reddit.com/r',
            search: '/search?q={}',
            color: 'linear-gradient(135deg, #223349, #0E3B43)',
        },
        {
            category: 'Lurk',
            name: 'Unsplash',
        ...
        },
        {
            ...
            color: 'linear-gradient(135deg, #1A2832, #7A0F2C)',
        },
        {
            category: 'Learn',
            name: 'Academy',
...
class Clock {
    ...
    _setTime() {
        ...
        if (this._last === "" + hours + minutes) return;
        else {
            this._last = "" + hours + minutes
        }
...
class Form {
    constructor(options) {
        ...
        $.el('#clock').addEventListener('click', this.show);
    }
